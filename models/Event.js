...
const eventSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: {
      values: ['conference', 'workshop', 'social', 'sports', 'music', 'business', 'education', 'other'],
      message: 'Category must be one of: conference, workshop, social, sports, music, business, education, other'
    }
  },
  maxAttendees: {
    type: Number,
